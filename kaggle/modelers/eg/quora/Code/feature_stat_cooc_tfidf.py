...
class StatCoocTF_Ngram(BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        ...
        super(StatCoocTF_Ngram, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.ngram = ngram
...
class StatCoocNormTF_Ngram(BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(StatCoocNormTF_Ngram, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.ngram = ngram
        self.ngram_str = ngram_utils._ngram_str_map[self.ngram]
        self.str_match_threshold = str_match_threshold
...
class StatCoocTFIDF_Ngram(BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(StatCoocTFIDF_Ngram, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.ngram = ngram
        self.ngram_str = ngram_utils._ngram_str_map[self.ngram]
        self.str_match_threshold = str_match_threshold
...
class StatCoocNormTFIDF_Ngram(BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(StatCoocNormTFIDF_Ngram, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.ngram = ngram
        self.ngram_str = ngram_utils._ngram_str_map[self.ngram]
        self.str_match_threshold = str_match_threshold
        self.df_dict = self._get_df_dict()
...
class StatCoocBM25_Ngram(BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        ...
        super(StatCoocBM25_Ngram, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.k1 = k1
        self.b = b
        self.ngram = ngram
        self.ngram_str = ngram_utils._ngram_str_map[self.ngram]
