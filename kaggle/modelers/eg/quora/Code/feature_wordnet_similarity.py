...
class WordNet_Similarity(BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, metric="path", aggregation_mode_prev="", aggregation_mode=""):
        super(WordNet_Similarity, self).__init__(obs_corpus, target_corpus, aggregation_mode, None, aggregation_mode_prev)
        self.metric = metric
        if self.metric == "path":
...
class WordNet_Path_Similarity(WordNet_Similarity):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode_prev="", aggregation_mode=""):
        super(WordNet_Path_Similarity, self).__init__(obs_corpus, target_corpus, "path", aggregation_mode_prev, aggregation_mode)


class WordNet_Lch_Similarity(WordNet_Similarity):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode_prev="", aggregation_mode=""):
        super(WordNet_Lch_Similarity, self).__init__(obs_corpus, target_corpus, "lch", aggregation_mode_prev, aggregation_mode)


class WordNet_Wup_Similarity(WordNet_Similarity):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode_prev="", aggregation_mode=""):
        super(WordNet_Wup_Similarity, self).__init__(obs_corpus, target_corpus, "wup", aggregation_mode_prev, aggregation_mode)
