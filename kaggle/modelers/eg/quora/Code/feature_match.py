...
class MatchQueryCount(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(MatchQueryCount, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class MatchQueryRatio(MatchQueryCount):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(MatchQueryRatio, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        
    def __name__(self):
        return "MatchQueryRatio"

    def transform_one(self, obs, target, id):
        return np_utils._try_divide(super(MatchQueryRatio, self).transform_one(obs, target, id), len(target.split(" ")))


#------------- Longest match features -------------------------------
class LongestMatchSize(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(LongestMatchSize, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class LongestMatchRatio(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(LongestMatchRatio, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class MatchAttrCount(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(MatchAttrCount, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class MatchAttrRatio(MatchQueryCount):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(MatchAttrRatio, self).__init__(obs_corpus, target_corpus, aggregation_mode)
    ...
    def transform_one(self, obs, target, id):
        ...
        return np_utils._try_divide(super(MatchAttrRatio, self).transform_one(obs, target, id), lo*lt)


class IsIndoorOutdoorMatch(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(IsIndoorOutdoorMatch, self).__init__(obs_corpus, target_corpus, aggregation_mode)
