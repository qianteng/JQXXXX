...
param_space_clf_xgb_tree_best_single_model = {
    ...
    "n_estimators" : 750,
    "learning_rate" : 0.064,
    "gamma": 1.17852429212e-06,
    "reg_alpha" : 0.0091486730895,
    "reg_lambda" : 6.71584103511e-10,
    "min_child_weight": 35.3805021294,
    "max_depth": 9,
    "subsample": 0.85,
    "colsample_bytree": 1,
...
param_space_clf_skl_etr = {
    ...
    "min_samples_split": hp.quniform("skl_etr__min_samples_split", 2, 15, 1),
