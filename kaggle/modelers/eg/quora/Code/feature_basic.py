...
class DocIdEcho(BaseEstimator):
    """For product_uid"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(DocIdEcho, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class ProductUidDummy1(BaseEstimator):
    """For product_uid"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(ProductUidDummy1, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class ProductUidDummy2(BaseEstimator):
    """For product_uid"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(ProductUidDummy2, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class ProductUidDummy3(BaseEstimator):
    """For product_uid"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(ProductUidDummy3, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrCount(BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrCount, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrBulletCount(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrBulletCount, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrBulletRatio(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrBulletRatio, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrNonBulletCount(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrNonBulletCount, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrNonBulletRatio(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrNonBulletRatio, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrHasProductHeight(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrHasProductHeight, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrHasProductWidth(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrHasProductWidth, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrHasProductLength(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrHasProductLength, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrHasProductDepth(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrHasProductDepth, self).__init__(obs_corpus, target_corpus, aggregation_mode)
...
class AttrHasIndoorOutdoor(BaseEstimator):
    """obs_corpus is a list of list of attributes"""
    def __init__(self, obs_corpus, target_corpus, aggregation_mode=""):
        super(AttrHasIndoorOutdoor, self).__init__(obs_corpus, target_corpus, aggregation_mode)
