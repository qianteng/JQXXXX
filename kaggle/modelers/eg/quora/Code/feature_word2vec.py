...
class Word2Vec_BaseEstimator(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, 
        ...
        super(Word2Vec_BaseEstimator, self).__init__(obs_corpus, target_corpus, aggregation_mode, None, aggregation_mode_prev)
...
class Word2Vec_Centroid_Vector(Word2Vec_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode=""):
        super(Word2Vec_Centroid_Vector, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode)
...
class Word2Vec_Importance(Word2Vec_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode=""):
        super(Word2Vec_Importance, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode)
...
class Word2Vec_N_Similarity(Word2Vec_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode=""):
        super(Word2Vec_N_Similarity, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode)
...
class Word2Vec_N_Similarity_Imp(Word2Vec_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode=""):
        super(Word2Vec_N_Similarity_Imp, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode)
...
class Word2Vec_Centroid_RMSE(Word2Vec_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode=""):
        super(Word2Vec_Centroid_RMSE, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode)
...
class Word2Vec_Centroid_RMSE_IMP(Word2Vec_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode=""):
        super(Word2Vec_Centroid_RMSE_IMP, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode)
...
class Word2Vec_Centroid_Vdiff(Word2Vec_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode=""):
        super(Word2Vec_Centroid_Vdiff, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, aggregation_mode)
...
class Word2Vec_CosineSim(Word2Vec_BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, word2vec_model, model_prefix, 
        aggregation_mode="", aggregation_mode_prev=""):
        super(Word2Vec_CosineSim, self).__init__(obs_corpus, target_corpus, word2vec_model, model_prefix, 
            aggregation_mode, aggregation_mode_prev)
