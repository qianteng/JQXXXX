...
class Count_Ngram_BaseEstimator(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, idx, aggregation_mode="", 
        ...
        super(Count_Ngram_BaseEstimator, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.idx = idx
        self.ngram = ngram
...
class FirstIntersectCount_Ngram(Count_Ngram_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(FirstIntersectCount_Ngram, self).__init__(obs_corpus, target_corpus, ngram, 0, aggregation_mode, str_match_threshold)
...
class LastIntersectCount_Ngram(Count_Ngram_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(LastIntersectCount_Ngram, self).__init__(obs_corpus, target_corpus, ngram, -1, aggregation_mode, str_match_threshold)
...
class Ratio_Ngram_BaseEstimator(Count_Ngram_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, idx, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(Ratio_Ngram_BaseEstimator, self).__init__(obs_corpus, target_corpus, ngram, idx, aggregation_mode, str_match_threshold)
    def transform_one(self, obs, target, id):
        obs_tokens = nlp_utils._tokenize(obs, token_pattern)
        target_tokens = nlp_utils._tokenize(target, token_pattern)
        obs_ngrams = ngram_utils._ngrams(obs_tokens, self.ngram)
...
class FirstIntersectRatio_Ngram(Ratio_Ngram_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(FirstIntersectRatio_Ngram, self).__init__(obs_corpus, target_corpus, ngram, 0, aggregation_mode, str_match_threshold)
...
class LastIntersectRatio_Ngram(Ratio_Ngram_BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode="", 
        str_match_threshold=config.STR_MATCH_THRESHOLD):
        super(LastIntersectRatio_Ngram, self).__init__(obs_corpus, target_corpus, ngram, -1, aggregation_mode, str_match_threshold)
...
class Position_Ngram_BaseEstimator(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, idx, aggregation_mode=""):
        super(Position_Ngram_BaseEstimator, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.idx = idx
        self.ngram = ngram
        self.ngram_str = ngram_utils._ngram_str_map[self.ngram]
    def transform_one(self, obs, target, id):
...
class FirstIntersectPosition_Ngram(Position_Ngram_BaseEstimator):
    ...
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode=""):
        super(FirstIntersectPosition_Ngram, self).__init__(obs_corpus, target_corpus, ngram, 0, aggregation_mode)
...
class LastIntersectPosition_Ngram(Position_Ngram_BaseEstimator):
    """Single aggregation features"""
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode=""):
        super(LastIntersectPosition_Ngram, self).__init__(obs_corpus, target_corpus, ngram, -1, aggregation_mode)
...
class NormPosition_Ngram_BaseEstimator(BaseEstimator):
    def __init__(self, obs_corpus, target_corpus, ngram, idx, aggregation_mode=""):
        super(NormPosition_Ngram_BaseEstimator, self).__init__(obs_corpus, target_corpus, aggregation_mode)
        self.idx = idx
        self.ngram = ngram
        self.ngram_str = ngram_utils._ngram_str_map[self.ngram]
    def transform_one(self, obs, target, id):
...
class FirstIntersectNormPosition_Ngram(NormPosition_Ngram_BaseEstimator):
    """Single aggregation features"""
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode=""):
        super(FirstIntersectNormPosition_Ngram, self).__init__(obs_corpus, target_corpus, ngram, 0, aggregation_mode)
...
class LastIntersectNormPosition_Ngram(NormPosition_Ngram_BaseEstimator):
    """Single aggregation features"""
    def __init__(self, obs_corpus, target_corpus, ngram, aggregation_mode=""):
        super(LastIntersectNormPosition_Ngram, self).__init__(obs_corpus, target_corpus, ngram, -1, aggregation_mode)
